"""Entrypoint for LiquidAI VIN training pipeline."""

from __future__ import annotations

import argparse

from pipelines.vin_liquidai_pipeline import vin_liquidai_pipeline


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run the LiquidAI VIN training pipeline.")
...
def main() -> None:
    args = parse_args()
    vin_liquidai_pipeline.with_options(
        settings={"experiment_tracker.mlflow": {"experiment_name": "VIN OCR LiquidAI"}}
    )(
